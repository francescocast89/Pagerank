...
public static int getNumNodes(Path input_file) throws IOException {
	...
	public static void parse_wiki_job(Configuration conf, String page, String pagelink, String out) throws IOException, ClassNotFoundException, InterruptedException {
			...
			job_parser.setOutputKeyClass(IntWritable.class);
			...
			job_parser.setMapperClass(PagelinkParser_Map_1.class);
			job_parser.setMapperClass(PagelinkParser_Map_2.class);
			job_parser.setReducerClass(PagelinkParser_Red.class);
			MultipleInputs.addInputPath(job_parser, parsedPageOutputPath, KeyValueTextInputFormat.class, PagelinkParser_Map_1.class);
			MultipleInputs.addInputPath(job_parser, pagelink_inputPath, KeyValueTextInputFormat.class, PagelinkParser_Map_2.class);
