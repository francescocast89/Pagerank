...
```
After that i've executed a second test in which the input file is links-simple-sorted.7z. This file decompressed is over 3GB and contains 12305050 entries. 
 ```
